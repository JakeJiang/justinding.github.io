                ...
                $(this).bind('click', function(ev){
                    ...
                    $(required).each(function(key, value) {
                        ...
                        if(($(this).val()==$(this).attr('placeholder')) || ($(this).val()=='')){
                            ...
                            if(opts.emptyMessage){
                                ...
                                $(opts.responseDiv).html('<p class="red">The '+$(this).attr('title')+' field is required.</p>');
                            }
                    ...
                    if(!emptyInput && !emailError){
                        ...
                        if(opts.async){
                            ...
                            if(opts.responseDiv){
                                $(opts.responseDiv).html("<p>Sending message...</p>");   
                            }
                            $.ajax({
                                url : opts.action,
                                type : opts.method,
                        ...
                        if(emptyInput){
                            ...
                            if(opts.emailMessage){
                                ...
                                $(opts.responseDiv).html('<p class="red">Please type a valid email address.</p>');
                            }
                            else if(opts.messages=='it'){
                        ...
                        //Button animation with animate.css
                        $('input:submit').addClass('shake');
                        setTimeout(function() {
                        	$('input:submit').removeClass('shake');
                        }, 1000);
                    }
                    return false;
                });
